...
import com.project.toyprojectspring.security.JwtAuthenticationFilter;
        ...
        http.authorizeHttpRequests(auth -> {
            try {
                auth.requestMatchers(new AntPathRequestMatcher("/"),
                        new AntPathRequestMatcher("/post/retrievePost"),
                        new AntPathRequestMatcher("/post/searchPost/**"),
                        new AntPathRequestMatcher("/post/retrieveDetail/**"),
                        new AntPathRequestMatcher("/auth/signup"),
                        new AntPathRequestMatcher("/auth/signin"),
                        new AntPathRequestMatcher("/mail/**")).permitAll();
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
